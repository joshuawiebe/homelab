...
read -rp "Enter reverse proxy to stop/start during backup (traefik or zoraxy, default: traefik): " PROXY_SERVICE
PROXY_SERVICE=${PROXY_SERVICE:-traefik}
...
# Borg repo and passphrase
BORG_REPO=$BORG_REPO
BORG_PASSPHRASE=$BORG_PASSPHRASE

# Log file (kept in auto_backup folder, not on backup drive)
...
# Reverse proxy for stopping/starting during backup
...
# Create systemd timer file (daily at user-selected BACKUP_TIME)
